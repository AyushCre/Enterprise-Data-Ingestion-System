...
import shutil
import time
import re  # <--- NEW IMPORT (Sorting ke liye)
...
def render_dashboard():
    ...
    # --- SECTION 3: DATA INSPECTOR (UPDATED SORTING LOGIC) ---
    ...
    # --- NEW SORTING LOGIC ---
    # Ye function filename me se number nikal kar sort karega (Natural Sort)
    # E.g., file_2 ab file_10 se pehle aayega.
    ...
    if processed_files:
        # User ab isme TYPE kar sakta hai. Search enabled hai by default.
